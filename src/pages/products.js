...
export default () => (
<Layout>
	<Hero img="/images/placeholder.png" href="/online/profile">
		...
		<Hero img="/images/placeholder.png" href="/online/system">
			<h2>ONLINE SYSTEM</h2>
		...
		<Hero img="/images/placeholder.png" href="/digital/content">
		...
		<Hero img="/images/placeholder.png" href="/digital/graphics">
