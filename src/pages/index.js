...
export default () => (
	<Layout>
		...
		<Hero img="/images/template.jpg" href="/profile">
		...
		<Hero img="/images/template.jpg" href="/system">
		...
		<Hero img="/images/template.jpg" href="/content">
		...
		<Hero img="/images/template.jpg" href="/graphics">
